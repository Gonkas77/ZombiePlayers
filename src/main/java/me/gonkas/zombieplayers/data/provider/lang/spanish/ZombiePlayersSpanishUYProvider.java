...
public class ZombiePlayersSpanishUYProvider extends FabricLanguageProvider {
    public ZombiePlayersSpanishUYProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
