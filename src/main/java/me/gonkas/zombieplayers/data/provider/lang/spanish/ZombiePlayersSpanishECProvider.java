...
public class ZombiePlayersSpanishECProvider extends FabricLanguageProvider {
    public ZombiePlayersSpanishECProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
